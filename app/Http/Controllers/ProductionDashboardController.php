...
class ProductionDashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        $machineJobs = MachineJob::with([
            ...
            'mouldChangeLogs' => function ($query) use ($today) {
            $query->whereDate('created_at', $today); // Only get today's mould change logs
        }
        ])
        ...
        foreach ($machineJobs as $machineJob) {
            ...
            // Process mould change logs if they exist
            if ($machineJob->mouldChangeLogs->isNotEmpty()) {
            ...
            // Process daily item codes if they exist
            if ($machineJob->dailyItemCode->isNotEmpty()) {
