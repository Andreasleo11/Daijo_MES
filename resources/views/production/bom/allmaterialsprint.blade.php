...
<head>
    ...
    <style>
        @media print {
            ...
            .grid {
                grid-template-columns: repeat(2, 1fr); /* Fit 2 cards per row for printing */
            }
    ...
    <div class="container mx-auto my-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-8 gap-4 print:grid-cols-2">
            @foreach ($childrenWithDetails as $index => $child)
                <div class="card flex flex-col items-center justify-center text-center bg-white p-4 border border-gray-300 rounded-lg shadow-md">
                    ...
                    <div class="mb-4">
                        ...
                        <img src="data:image/png;base64,{{ $child->barcode }}" alt="Barcode" class="h-24 object-contain">
                    </div>
