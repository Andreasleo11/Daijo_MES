...
<section class="header py-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-semibold text-gray-800">Capacity By Forecast (DISTRIBUTION SECTION)</h1>
        </div>
    </div>
</section>
    ...
    <div class="bg-white shadow-md rounded-lg mt-5">
        <div class="p-4">
            <div class="overflow-x-auto">
                ...
                {{ $dataTable->table(['class' => 'min-w-full table-auto text-sm text-left text-gray-500', 'id' => 'caplinedistribution-table']) }}
            </div>
        </div>
    </div>
