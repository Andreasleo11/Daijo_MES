...
<div class="container mx-auto p-8">
    ...
    <form method="GET" action="{{ route('delschedfinal.dashboard') }}" class="mb-6">
        <div class="mb-4">
            ...
            <input type="number" name="days" id="days" class="mt-2 p-2 w-full border border-gray-300 rounded-lg" required min="1">
        </div>
    ...
    @if($datas->isEmpty())
        ...
        @else
            <div class="overflow-x-auto bg-white shadow-lg rounded-lg">
                <table class="min-w-full table-auto border-collapse" style="max-height: 400px; overflow-y: auto; display: block;">
