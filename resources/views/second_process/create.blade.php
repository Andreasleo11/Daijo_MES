                ...
                <div class="bg-white shadow-xl rounded-lg overflow-hidden mb-6 border border-gray-200">
                    ...
                    <div class="bg-gradient-to-r from-blue-700 to-indigo-800 text-white p-6">
                        ...
                        <div class="text-center mt-6">
                            <h2 class="text-2xl font-bold uppercase tracking-wider">Laporan Produksi Harian</h2>
                        </div>
                    </div>
                            ...
                            <div class="bg-gray-50 p-5 rounded-lg border border-gray-200">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                    <div>
                                        ...
                                        <input type="date" name="date" value="{{ date('Y-m-d') }}" class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm" required>
                                    </div>
                                    <div>
                                        <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Unit / Line</label>
                                        <input type="text" name="unit_line" placeholder="C / 2 / etc." class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm" required>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <select name="output_destination" class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm">
                                            ...
                                            <option value="amplas">Amplas</option>
                                            <option value="treatment">Treatment</option>
                                            <option value="assy">Assembly (Assy)</option>
                                            <option value="rework">Rework</option>
                                        </select>
                                    </div>
                                    <div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        ...
                                        <div class="p-3 space-y-2">
                                            @for ($i = 1; $i <= 4; $i++)
                                                <div class="flex items-center space-x-2">
                                                    ...
                                                    <input type="text" name="manpower[{{ $i }}][name]" placeholder="Operator Name" class="w-full text-xs rounded border-gray-300 py-1">
                                                </div>
                                            @endfor
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm">
                                        ...
                                        <div class="p-3 space-y-2">
                                            @for ($i = 1; $i <= 4; $i++)
                                                @php $sprIndex = 4 + $i; @endphp
                                                <div class="flex items-center space-x-2">
                                                    <span class="text-xs font-bold text-gray-500 w-6 text-right">{{ $i }}</span>
                                                    <input type="hidden" name="manpower[{{ $sprIndex }}][role]" value="sprayer">
                                                    <input type="hidden" name="manpower[{{ $sprIndex }}][no]" value="{{ $i }}">
                                                    <input type="text" name="manpower[{{ $sprIndex }}][name]" placeholder="Sprayer Name" class="w-full text-xs rounded border-gray-300 py-1">
                                                </div>
                                            @endfor
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm">
                                        ...
                                        <div class="p-3 space-y-2">
                                            @for ($i = 1; $i <= 4; $i++)
                                                @php $chkIndex = 8 + $i; @endphp
                                                <div class="flex items-center space-x-2">
                                                    <span class="text-xs font-bold text-gray-500 w-6 text-right">{{ $i }}</span>
                                                    <input type="hidden" name="manpower[{{ $chkIndex }}][role]" value="checker">
                                                    <input type="hidden" name="manpower[{{ $chkIndex }}][no]" value="{{ $i }}">
                                                    <input type="text" name="manpower[{{ $chkIndex }}][name]" placeholder="Checker Name" class="w-full text-xs rounded border-gray-300 py-1">
                                                </div>
                                            @endfor
                                        </div>
                                    </div>
                                        ...
                                        <tbody class="divide-y divide-gray-200">
                                            @foreach ($defaultPaints as $index => $paint)
                                                <tr>
                                                    ...
                                                    <td class="px-4 py-2">
                                                        <input type="text" name="materials[{{ $index }}][lot_number]" placeholder="Lot" class="w-full text-xs rounded border-gray-300 py-1">
                                                    </td>
                                                    <td class="px-4 py-2">
                                                        <input type="text" name="materials[{{ $index }}][visco]" placeholder="Visco" class="w-full text-xs rounded border-gray-300 py-1">
                                                    </td>
                                                    <td class="px-4 py-2">
                                                        <input type="text" name="materials[{{ $index }}][mixing_ratio]" placeholder="Ratio (e.g. 1:1.5)" class="w-full text-xs rounded border-gray-300 py-1">
                                                    </td>
                                                    <td class="px-4 py-2">
                                                        <input type="number" name="materials[{{ $index }}][qty]" placeholder="Qty" class="w-full text-xs rounded border-gray-300 py-1">
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200 text-sm">
                                        ...
                                        <tbody class="divide-y divide-gray-200">
                                            @foreach ($defaultParts as $index => $part)
                                                @php $ptIndex = count($defaultPaints) + $index; @endphp
                                                <tr>
                                                    <td class="px-4 py-2">
                                                    ...
                                                    <td class="px-4 py-2">
                                                        <input type="text" name="materials[{{ $ptIndex }}][lot_number]" placeholder="Lot" class="w-full text-xs rounded border-gray-300 py-1">
                                                    </td>
                                                    <td class="px-4 py-2">
                                                        <input type="number" name="materials[{{ $ptIndex }}][qty]" placeholder="Qty" class="w-full text-xs rounded border-gray-300 py-1">
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                            ...
                            <div class="bg-blue-50 p-5 rounded-lg border border-blue-100">
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-3">
                                    <div>
                                        ...
                                        <input type="number" name="target_per_hour" id="target_per_hour" value="0" class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-xs py-1">
                                    </div>
                                    <div>
                                        <label class="block text-[10px] font-bold text-gray-600 uppercase mb-1">Jml Input WIP</label>
                                        <input type="number" name="jml_input_wip" id="jml_input_wip" value="0" class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-xs py-1">
                                    </div>
                                    <div>
                                        <label class="block text-[10px] font-bold text-gray-600 uppercase mb-1">Repairan</label>
                                        <input type="number" name="repairan" id="repairan" value="0" class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-xs py-1">
                                    </div>
                                    <div>
                                        <label class="block text-[10px] font-bold text-gray-600 uppercase mb-1">Jumlah Output</label>
                                        <input type="number" name="jumlah_output" id="jumlah_output" value="0" class="w-full rounded border-gray-300 bg-gray-100 text-xs py-1 font-bold text-gray-800" readonly>
                                    </div>
                                    <div>
                                        <label class="block text-[10px] font-bold text-green-700 uppercase mb-1 font-extrabold">Jumlah OK</label>
                                        <input type="number" name="jumlah_ok" id="jumlah_ok" value="0" class="w-full rounded border-gray-300 bg-gray-100 text-xs py-1 font-bold text-green-700" readonly>
                                    </div>
                                    <div>
                                        <label class="block text-[10px] font-bold text-red-700 uppercase mb-1 font-extrabold">Jumlah NG</label>
                                        <input type="number" name="jumlah_ng" id="jumlah_ng" value="0" class="w-full rounded border-gray-300 bg-gray-100 text-xs py-1 font-bold text-red-700" readonly>
                                    </div>
                                    <div>
                                        <label class="block text-[10px] font-bold text-red-600 uppercase mb-1">NG %</label>
                                        <input type="number" name="ng_prosentase" id="ng_prosentase" step="0.01" value="0" class="w-full rounded border-gray-300 bg-gray-100 text-xs py-1 font-semibold text-red-600" readonly>
                                    </div>
                                    <div>
                                        <label class="block text-[10px] font-bold text-gray-600 uppercase mb-1">Jml NG Lebur</label>
                                        <input type="number" name="jml_ng_lebur" id="jml_ng_lebur" value="0" class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-xs py-1">
                                    </div>
                                </div>
                            </div>
                                                ...
                                                @for ($hour = 1; $hour <= 8; $hour++)
                                                    <tr class="hourly-ok-row" data-hour="{{ $hour }}">
                                                        ...
                                                        <td class="px-4 py-2">
                                                            ...
                                                            <input type="number" name="hourly[{{ $hour }}][ok_qty]" placeholder="Qty OK" class="w-full text-xs rounded border-gray-300 py-1 text-center hourly-ok-input">
                                                        </td>
                                                        <td class="px-4 py-2">
                                                            <input type="number" name="hourly[{{ $hour }}][acumulasi_qty]" placeholder="Acumulasi" class="w-full text-xs rounded border-gray-300 bg-gray-100 py-1 text-center font-semibold hourly-accum-input" readonly>
                                                        </td>
                                                    </tr>
                                                @endfor
                                            </tbody>
                                                ...
                                                @foreach ($defaultNgs as $index => $ng)
                                                    <tr class="ng-row">
                                                        ...
                                                        <td class="px-2 py-2 font-extrabold text-red-600">
                                                            <input type="number" name="ngs[{{ $index }}][total_ng]" value="0" class="w-full text-center rounded border-gray-300 bg-gray-100 p-1 text-xs font-bold text-red-600 ng-total-output" readonly>
                                                        </td>
                                                        <td class="px-2 py-2 flex space-x-1 items-center">
                                                            <input type="text" name="ngs[{{ $index }}][ng_input_item]" placeholder="Item NG" class="w-2/3 rounded border-gray-300 p-1 text-xs">
                                                            <input type="number" name="ngs[{{ $index }}][ng_input_qty]" placeholder="Qty" class="w-1/3 rounded border-gray-300 p-1 text-xs">
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        ...
                                        <tbody class="divide-y divide-gray-200">
                                            @foreach ($defaultTroubles as $index => $trouble)
                                                <tr>
                                                    ...
                                                    <td class="px-4 py-2">
                                                        <textarea name="troubles[{{ $index }}][masalah]" rows="1" class="w-full rounded border-gray-300 text-xs py-1" placeholder="Problem description..."></textarea>
                                                    </td>
                                                    <td class="px-4 py-2">
                                                        <textarea name="troubles[{{ $index }}][penanganan]" rows="1" class="w-full rounded border-gray-300 text-xs py-1" placeholder="Describe actions..."></textarea>
                                                    </td>
                                                    <td class="px-4 py-2 flex space-x-1 items-center">
                                                        <input type="number" name="troubles[{{ $index }}][loss_time_minutes]" placeholder="Mins" class="w-1/2 text-xs rounded border-gray-300 py-1">
                                                        <input type="text" name="troubles[{{ $index }}][loss_time]" placeholder="e.g. 15 mins" class="w-1/2 text-xs rounded border-gray-300 py-1">
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50 p-5 rounded-lg border border-gray-200 text-sm">
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <textarea name="production_notes" rows="4" class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-xs" placeholder="General production notes..."></textarea>
                                    </div>
                                    <div class="mt-3">
                                        <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Catatan / Remarks NG</label>
                                        <textarea name="ng_remarks" rows="2" class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-xs" placeholder="Remarks for NG causes..."></textarea>
                                    </div>
                                    <div>
                                        <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Karyawan Tidak Hadir</label>
                                        <input type="text" name="absent_employees" placeholder="Absent employees list..." class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-xs">
                                    </div>
                                </div>
                                <div class="space-y-4">
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                        @for ($i = 1; $i <= 4; $i++)
                                            <div class="flex items-center space-x-2">
                                                <span class="text-xs font-bold text-gray-500 w-4">{{ $i }}.</span>
