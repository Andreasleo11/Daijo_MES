                        ...
                        <div class="bg-gray-50 p-5 rounded-lg border border-gray-200">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="process_prod" placeholder="Painting / etc." class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm" required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="target_per_hour" id="target_per_hour" value="0" class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm">
                                </div>
                                <div>
                                    <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Jml Input WIP</label>
                                    <input type="number" name="jml_input_wip" id="jml_input_wip" value="0" class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm">
                                </div>
                                <div>
                                    <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Repairan</label>
                                    <input type="number" name="repairan" id="repairan" value="0" class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm">
                                </div>
                                <div>
                                    <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Jumlah Output</label>
                                    <input type="number" name="jumlah_output" id="jumlah_output" value="0" class="w-full rounded border-gray-300 bg-gray-100 text-sm font-semibold" readonly>
                                </div>

                                <div>
                                    <label class="block text-xs font-bold text-gray-700 uppercase mb-1 text-green-700 font-extrabold">Jumlah OK</label>
                                    <input type="number" name="jumlah_ok" id="jumlah_ok" value="0" class="w-full rounded border-gray-300 bg-gray-100 text-sm font-semibold text-green-700" readonly>
                                </div>
                                <div>
                                    <label class="block text-xs font-bold text-gray-700 uppercase mb-1 text-red-700 font-extrabold">Jumlah NG</label>
                                    <input type="number" name="jumlah_ng" id="jumlah_ng" value="0" class="w-full rounded border-gray-300 bg-gray-100 text-sm font-semibold text-red-700" readonly>
                                </div>
                                <div>
                                    <label class="block text-xs font-bold text-gray-700 uppercase mb-1 text-red-700">NG Prosentase (%)</label>
                                    <input type="number" name="ng_prosentase" id="ng_prosentase" step="0.01" value="0" class="w-full rounded border-gray-300 bg-gray-100 text-sm font-semibold text-red-700" readonly>
                                </div>
                                <div>
                                    <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Jml NG Lebur</label>
                                    <input type="number" name="jml_ng_lebur" id="jml_ng_lebur" value="0" class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm">
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody class="divide-y divide-gray-200">
                                        @foreach($defaultTroubles as $index => $trouble)
                                            <tr>
                                                ...
                                                <td class="px-4 py-2">
                                                    <input type="text" name="troubles[{{ $index }}][loss_time]" placeholder="e.g. 15 mins" class="w-full text-xs rounded border-gray-300 py-1">
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-3 gap-2 pt-4 border-t border-gray-200">
                                    <div>
                                        ...
                                        <input type="text" name="created_by_name" placeholder="Operator Name" class="w-full text-xs rounded border-gray-300 py-1">
                                    </div>
                                    <div>
                                        <label class="block text-[10px] font-bold text-gray-500 uppercase mb-1">PQC</label>
                                        <input type="text" name="pqc_name" placeholder="PQC Inspector" class="w-full text-xs rounded border-gray-300 py-1">
                                    </div>
                                    <div>
                                        <label class="block text-[10px] font-bold text-gray-500 uppercase mb-1">Mengetahui</label>
                                        <input type="text" name="acknowledged_by_name" placeholder="Supervisor" class="w-full text-xs rounded border-gray-300 py-1">
                                    </div>
                                </div>
                            </div>
                        </div>
