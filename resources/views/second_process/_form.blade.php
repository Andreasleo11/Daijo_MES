                ...
                <div class="bg-white shadow-xl rounded-lg overflow-hidden mb-6 border border-gray-200">
                    ...
                    <div class="border-b border-gray-200 bg-gray-50 px-6 py-3">
                        <nav class="-mb-px flex flex-wrap justify-between sm:justify-start gap-2 md:gap-6"
                            aria-label="Tabs" id="form-tabs-navigation">
                        ...
                        <div id="tab-content-setup" class="tab-pane space-y-8">
                            ...
                            <div class="bg-gray-50 p-5 rounded-lg border border-gray-200">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                    <div>
                                        <label
                                            class="block text-xs font-bold text-gray-700 uppercase mb-1">Tanggal</label>
                                        <input type="date" name="date"
                                            value="{{ old('date', $report->date ?? date('Y-m-d')) }}"
                                    ...
                                    <div>
                                        <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Unit /
                                            Line</label>
                                        <input type="text" name="unit_line"
                                            value="{{ old('unit_line', $report->unit_line) }}"
                                            class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm"
                                            required>
                                    </div>
                                    <div>
                                        <label
                                            class="block text-xs font-bold text-gray-700 uppercase mb-1">Shift</label>
                                        <select name="shift"
                                            class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm"
                                            required>
                                            <option value="1"
                                                {{ old('shift', $report->shift) == '1' ? 'selected' : '' }}>Shift 1
                                            </option>
                                            <option value="2"
                                                {{ old('shift', $report->shift) == '2' ? 'selected' : '' }}>Shift 2
                                            </option>
                                            <option value="3"
                                                {{ old('shift', $report->shift) == '3' ? 'selected' : '' }}>Shift 3
                                            </option>
                                        </select>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <label
                                            class="block text-xs font-bold text-gray-700 uppercase mb-1">Model</label>
                                        <input type="text" name="model"
                                            value="{{ old('model', $report->model) }}" placeholder="Model"
                                            class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm"
                                            required>
                                    </div>
                                    <div>
                                        <label
                                            class="block text-xs font-bold text-gray-700 uppercase mb-1">Customer</label>
                                        <div class="relative">
                                        ...
                                        <tbody class="divide-y divide-gray-200">
                                            ...
                                            @foreach ($defaultPaints as $index => $paint)
                                                ...
                                                <tr>
                                                    <td class="px-4 py-2">
                                                        <span
                                                            class="text-gray-700 font-semibold">{{ $paint }}</span>
                                                        <input type="hidden"
                                                    ...
                                                    <td class="px-4 py-2">
                                                        <input type="text"
                                                            ...
                                                            value="{{ $match ? $match->lot_number : '' }}"
                                                            placeholder="Lot"
                                                            class="w-full text-xs rounded border-gray-300 py-1">
                                                    </td>
                                                    <td class="px-4 py-2">
                                                        <input type="text"
                                                            name="materials[{{ $index }}][visco]"
                                                            value="{{ $match ? $match->visco : '' }}"
                                                            placeholder="Visco"
                                                            class="w-full text-xs rounded border-gray-300 py-1">
                                                    </td>
                                                    <td class="px-4 py-2">
                                                        <input type="text"
                                                            name="materials[{{ $index }}][mixing_ratio]"
                                        ...
                                        <tbody class="divide-y divide-gray-200">
                                            ...
                                            @foreach ($defaultParts as $index => $part)
                                                ...
                                                <tr>
                                                    <td class="px-4 py-2">
                                                        <span
                                                            class="text-gray-700 font-semibold">{{ $part }}</span>
                                                        <input type="hidden"
                                                            name="materials[{{ $ptIndex }}][type]"
                                                            value="part">
                                                        <input type="hidden"
                                                            name="materials[{{ $ptIndex }}][item_name]"
                                                            value="{{ $part }}">
                                                    </td>
                                                    <td class="px-4 py-2">
                                                        <input type="text"
                                                            name="materials[{{ $ptIndex }}][lot_number]"
                                                            value="{{ $match ? $match->lot_number : '' }}"
                                                            placeholder="Lot"
                                                            class="w-full text-xs rounded border-gray-300 py-1">
                                                    </td>
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    ...
                                    <div class="col-span-2 md:col-span-4 lg:col-span-2 grid grid-cols-2 gap-4">
                                        <div
                                            ...
                                            <label
                                                class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Target
                                                Perjam</label>
                                        ...
                                        <div
                                            class="bg-white p-4 rounded-xl shadow-sm border border-gray-200 hover:border-blue-300 transition-colors">
                                            <label
                                                class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Jml
                                                Input WIP</label>
                                        ...
                                        <div
                                            ...
                                            <input type="number" name="repairan" id="repairan"
                                                value="{{ $report->repairan }}"
                                                class="w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm font-semibold transition-all"
                                                placeholder="0">
                                        </div>
                                        <div
                                    ...
                                    <div class="col-span-2 md:col-span-4 lg:col-span-2 grid grid-cols-2 gap-4">
                                        ...
                                        <div
                                            ...
                                            <label
                                                ...
                                                OK</label>
                                            <input type="number" name="jumlah_ok" id="jumlah_ok"
                                                value="{{ $report->jumlah_ok }}"
                                        ...
                                        <div
                                            ...
                                            <label
                                                ...
                                                NG</label>
                                            <input type="number" name="jumlah_ng" id="jumlah_ng"
                                                value="{{ $report->jumlah_ng }}"
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center relative z-10">
                                                <input type="number" name="ng_prosentase" id="ng_prosentase"
                                                    step="0.01" value="{{ $report->ng_prosentase }}"
                                ...
                                <div
                                    ...
                                    <div class="overflow-x-auto">
                                        ...
                                        <table class="min-w-full divide-y divide-gray-200 text-sm table-fixed"
                                            ...
                                            <thead
                                                class="bg-gray-50 text-gray-500 font-semibold text-xs tracking-wider uppercase">
                                                          ...
                                                          <th class="group px-3 py-2 w-32 text-center ng-type-header relative select-none border-b border-gray-200"
                                                              ...
                                                              <div class="flex flex-col space-y-1">
                                                                  <div class="flex items-center justify-center space-x-1">
                                                                      <span class="font-bold text-xs uppercase">{{ $ng }}</span>
                                                                      <button type="button" class="text-red-500 hover:text-red-700 opacity-0 group-hover:opacity-100 transition-opacity delete-ng-col-btn text-[10px] font-bold" data-ng="{{ $ng }}" title="Delete {{ $ng }}">&times;</button>
                                                                  </div>
                                                                  @php
                                                                      $hasRemark = $ngRecord && (!empty($ngRecord->ng_input_item) || ($ngRecord->ng_input_qty !== null && $ngRecord->ng_input_qty !== ''));
                                                                      $btnClass = $hasRemark 
                                                                      ...
                                                                      if ($hasRemark) {
                                                                          ...
                                                                          if ($item && $qty !== null) {
                                                                               $prettified = preg_replace('/\[(\d+)\]\s*([^\|]+)/', '$1x $2', $item);
                                                                  ...
                                                                  <button type="button" 
                                                                      ...
                                                                      data-ng-name="{{ $ng }}"
                                                                      data-ng-index="{{ $index }}">
                                                                      <span class="truncate remark-preview-label">{{ $labelText }}</span>
                                                                  ...
                                                                  <input type="hidden" name="ngs[{{ $index }}][ng_input_item]" value="{{ $ngRecord ? $ngRecord->ng_input_item : '' }}" class="ng-input-item-hidden">
                                                                  <input type="hidden" name="ngs[{{ $index }}][ng_input_qty]" value="{{ $ngRecord ? $ngRecord->ng_input_qty : '' }}" class="ng-input-qty-hidden">
                                                                  <input type="hidden" name="ngs[{{ $index }}][ng_name]" value="{{ $ng }}">
                                                                  <input type="hidden" name="ngs[{{ $index }}][total_ng]" id="ng-total-hidden-{{ $index }}" value="{{ $ngRecord ? $ngRecord->total_ng : 0 }}">
                                                              </div>
                                                          </th>
                                                    @endforeach
                                                </tr>
                                            ...
                                            <tbody class="divide-y divide-gray-100 bg-white" id="production-tbody">
                                                @for ($hour = 1; $hour <= $currentHoursCount; $hour++)
                                                    @php
                                                        $hourlyMatch = $report->hourlyProductions
                                                            ->where('hour_ke', $hour)
                                                            ->first();
                                                    @endphp
                                                    <tr class="production-row hover:bg-blue-50/50 transition-colors duration-100"
                                                        ...
                                                        <!-- OK Qty -->
                                                        <td
                                                            class="px-2 py-1.5 bg-green-50/30 border-l border-green-100">
                                                            <input type="number"
                                                                name="hourly[{{ $hour }}][hour_ke]"
                                                        ...
                                                        <!-- Accum OK (Readonly) -->
                                                        <td
                                                            class="px-2 py-1.5 bg-green-50/30 border-r border-green-100">
                                                            <input type="number"
                                                                name="hourly[{{ $hour }}][acumulasi_qty]"
                                                        ...
                                                        @foreach ($defaultNgs as $index => $ng)
                                                            @php
                                                                $ngRecord = $report->ngRecords
                                                                    ->where('ng_name', $ng)
                                                                    ->first();
                                                                $ngDetail = $ngRecord
                                                                    ? $ngRecord->hourlyDetails
                                                                        ->where('hour_ke', $hour)
                                                                        ->first()
                                                                    : null;
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-4 py-2 flex space-x-1 items-center">
                                                        <input type="number"
                                                            ...
                                                            value="{{ $match ? $match->loss_time_minutes : '' }}"
                                                            placeholder="Mins"
                                                            class="w-1/2 text-xs rounded border-gray-300 py-1">
                                                        <input type="text"
                                                            name="troubles[{{ $index }}][loss_time]"
                                                            value="{{ $match ? $match->loss_time : '' }}"
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Karyawan
                                            Tidak Hadir</label>
                                        <input type="text" name="absent_employees"
                                            value="{{ $report->absent_employees }}"
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                        @for ($i = 0; $i < 4; $i++)
                                            ...
                                            <div class="flex items-center space-x-2">
                                                <span
                                                    class="text-xs font-bold text-gray-500 w-4">{{ $i + 1 }}.</span>
                                                <input type="text" name="next_production_schedule[]"
                                                    value="{{ $schVal }}" placeholder="Next schedule item"
                ...
                <dialog id="ng-remark-modal" class="rounded-xl shadow-2xl w-full max-w-md p-0 overflow-hidden backdrop:bg-black/50 backdrop:backdrop-blur-sm">
                    <div class="flex flex-col bg-white">
                        <div class="bg-gradient-to-r from-blue-700 to-indigo-800 px-6 py-4 text-white flex justify-between items-center">
                            <h3 class="font-bold text-lg" id="modal-ng-title">Defect Detail</h3>
                            <button type="button" class="text-white hover:text-gray-200 text-xl font-bold close-modal-btn">&times;</button>
                        </div>
                        <div class="p-6 space-y-4">
                            <div id="modal-rows-container" class="space-y-3 max-h-60 overflow-y-auto">
                                <!-- Dynamic rows injected here -->
                            </div>
                            <button type="button" id="add-modal-row-btn" class="w-full py-1.5 border border-dashed border-blue-400 hover:border-blue-600 text-blue-600 hover:text-blue-800 text-xs font-bold rounded flex items-center justify-center transition select-none">
                        ...
                        <div class="bg-gray-50 px-6 py-3 flex justify-end space-x-2 border-t border-gray-100">
                            <button type="button" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 text-sm font-semibold rounded transition close-modal-btn">Cancel</button>
                            <button type="button" id="save-modal-remark-btn" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded shadow transition">Save Details</button>
                        </div>
                    </div>
                </dialog>
                ...
                <script>
                    ...
                    <tr class="production-row hover:bg-blue-50/50 transition-colors duration-100" data-hour="${newHour}">
                        ...
                        addNgTypeBtn.addEventListener('click', function() {
                            ...
                            th.className = 'group px-3 py-2 w-32 text-center ng-type-header relative select-none border-b border-gray-200';
                        ...
                        function deleteNgType(ngName) {
                            const countWithValues = Array.from(document.querySelectorAll(`.ng-cell[data-ng="${ngName}"] input.ng-hourly-input`))
                        ...
                        function reindexNgs() {
                            activeNgs.forEach((ng, newIndex) => {
                                document.querySelectorAll(`.ng-cell[data-ng="${ng}"] input.ng-hourly-input`).forEach(input => {
                        ...
                        function calculateNgTotals() {
                            ...
                            activeNgs.forEach((ng, index) => {
                                const colInputs = document.querySelectorAll(`.ng-hourly-input[data-ng-index="${index}"]`);
                                let colTotal = 0;
                    ...
                    `;
                        ...
                        saveModalBtn.addEventListener('click', function() {
                            ...
                            if (hasVal) {
                                activeRemarkButton.classList.remove('bg-gray-50', 'border-gray-200', 'text-gray-500', 'hover:bg-blue-50', 'hover:text-blue-700', 'font-semibold');
                                activeRemarkButton.classList.add('bg-blue-50', 'border-blue-200', 'text-blue-700', 'hover:bg-blue-100', 'font-bold');
                                ...
                                activeRemarkButton.classList.remove('bg-blue-50', 'border-blue-200', 'text-blue-700', 'hover:bg-blue-100', 'font-bold');
                                activeRemarkButton.classList.add('bg-gray-50', 'border-gray-200', 'text-gray-500', 'hover:bg-blue-50', 'hover:text-blue-700', 'font-semibold');
