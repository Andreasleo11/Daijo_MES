...
<div class="bg-white shadow-xl rounded-lg overflow-hidden mb-6 border border-gray-200">
    ...
    <div class="border-b border-gray-200 bg-gray-50 px-6 py-3">
        <nav class="-mb-px flex flex-wrap justify-between sm:justify-start gap-2 md:gap-6" aria-label="Tabs"
            ...
            <button type="button" data-tab="ipqc"
                class="tab-btn border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-3 px-3 border-b-2 font-bold text-sm flex items-center transition-all">
        ...
        <div id="tab-content-ipqc" class="tab-pane hidden space-y-8">
            ...
            <div id="first-piece-gate-banner" class="bg-gray-50 border border-gray-200 p-4 rounded-lg flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div id="first-piece-gate-action">
                    <!-- Dynamic link or button injected via JS -->
                </div>
            </div>
            ...
            <!-- Per 2-Hour Period IPQC Inspection Table -->
            <div class="bg-gray-50 p-5 rounded-lg border border-gray-200">
                <h3 class="text-lg font-bold text-gray-800 mb-4 border-b pb-2 flex items-center justify-between">
                    <span>IPQC 2-Hour Period Checks</span>
                    <span class="text-xs font-normal text-gray-500">Day/Night Shift 2-Hour Intervals</span>
                </h3>

                <div class="overflow-x-auto">
                    <table class="min-w-full text-xs border-collapse border border-gray-300 bg-white">
                        <thead class="bg-gray-100 text-gray-700 font-bold uppercase text-center">
                            <tr>
                                <th class="border border-gray-300 px-2 py-2">Period / Hour</th>
                                ...
                                <th class="border border-gray-300 px-2 py-2">Tape Test</th>
                                <th class="border border-gray-300 px-2 py-2">Tape Photo Proof</th>
                                <th class="border border-gray-300 px-2 py-2">Output Qty</th>
                                <th class="border border-gray-300 px-2 py-2">Sample Qty</th>
                                <th class="border border-gray-300 px-2 py-2">Rej Sample</th>
                                <th class="border border-gray-300 px-2 py-2">Rej Rate (%)</th>
                                <th class="border border-gray-300 px-2 py-2">Pass Qty</th>
                                <th class="border border-gray-300 px-2 py-2">Rej Qty</th>
                                <th class="border border-gray-300 px-2 py-2">Period Judgment</th>
                            </tr>
                        </thead>
                        <tbody>
                            @for ($h = 1; $h <= $currentHoursCount; $h++)
                                ...
                                @endphp
                                <tr class="hover:bg-purple-50/50 transition border-b border-gray-200 text-center">
                                    <!-- Period / Hour -->
            ...
            <!-- IPQC Overall Sign-Offs & Physical Proof Section -->
            <div class="bg-gray-50 p-5 rounded-lg border border-gray-200 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <h3 class="text-sm font-bold text-gray-800 uppercase mb-3">IPQC Sign-off Info</h3>
