                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <select name="process_prod" class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm" required>
                                            <option value="Painting" {{ $report->process_prod == 'Painting' ? 'selected' : '' }}>Painting</option>
                                            <option value="Buffing" {{ $report->process_prod == 'Buffing' ? 'selected' : '' }}>Buffing</option>
                                            <option value="Amplas" {{ $report->process_prod == 'Amplas' ? 'selected' : '' }}>Amplas</option>
                                            <option value="Treatment" {{ $report->process_prod == 'Treatment' ? 'selected' : '' }}>Treatment</option>
                                            <option value="Packing" {{ $report->process_prod == 'Packing' ? 'selected' : '' }}>Packing</option>
                                            <option value="Rework" {{ $report->process_prod == 'Rework' ? 'selected' : '' }}>Rework</option>
                                        </select>
                                    </div>
                                    <input type="hidden" name="status" id="status-field" value="{{ $report->status }}">
                                    <div>
                                        ...
                                        <select name="output_destination" class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm">
                                            <option value="" {{ empty($report->output_destination) ? 'selected' : '' }}>-- Select Next Step --</option>
                                            <option value="fg" {{ $report->output_destination == 'fg' ? 'selected' : '' }}>Finished Goods (FG)</option>
                                            <option value="buffing" {{ $report->output_destination == 'buffing' ? 'selected' : '' }}>Buffing</option>
                                            <option value="packing" {{ $report->output_destination == 'packing' ? 'selected' : '' }}>Packing</option>
                                            <option value="amplas" {{ $report->output_destination == 'amplas' ? 'selected' : '' }}>Amplas</option>
                                            <option value="treatment" {{ $report->output_destination == 'treatment' ? 'selected' : '' }}>Treatment</option>
                                            <option value="assy" {{ $report->output_destination == 'assy' ? 'selected' : '' }}>Assembly (Assy)</option>
                                            <option value="rework" {{ $report->output_destination == 'rework' ? 'selected' : '' }}>Rework</option>
                                        </select>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="model" value="{{ $report->model }}" placeholder="Model" class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm" required>
                                    </div>
                                    <div>
