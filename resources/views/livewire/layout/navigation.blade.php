...
<nav x-data="{ open: false }" class="bg-brightBlue border-b border-gray-100">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('production.bom.index')" :active="request()->routeIs('production.bom.index')" wire:navigate>
                {{ __('Production BOM') }}
            </x-responsive-nav-link>
        </div>
