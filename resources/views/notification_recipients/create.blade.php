<x-app-layout>
    <div class="container mx-auto pt-10 px-10">
        <h1 class="text-2xl font-bold mb-5">Add Notification Recipient</h1>

        <form action="{{ route('notification_recipients.store') }}" method="POST" class="bg-white p-6 rounded shadow-md">
            @csrf
            <div class="mb-4">
